...
const datasets = [
  { name: "GlobalPatterns", marker: "16S", description: { fr: "Jeu de données environnemental varié, adapté à une première prise en main complète de l’interface.", en: "A varied environmental dataset suited to a first complete tour of the interface." }, file: "GlobalPatterns.RData", size: "425 KB" },
  { name: "enterotype", marker: "16S", description: { fr: "Objet issu de données du microbiome intestinal humain, utile pour tester l’import et les comparaisons par groupes.", en: "An object based on human gut microbiome data, useful for testing import and group comparisons." }, file: "enterotype.RData", size: "191 KB" },
  { name: "soilrep", marker: "16S", description: { fr: "Objet consacré à la reproductibilité de données de microbiome du sol.", en: "An object focused on reproducibility in soil microbiome data." }, file: "soilrep.RData", size: "RData" },
  { name: "esophagus", marker: "16S", description: { fr: "Petit objet phyloseq, pratique pour vérifier rapidement l’import et la navigation.", en: "A small phyloseq object convenient for quickly checking import and navigation." }, file: "esophagus.RData", size: "RData" }
];
...
export default function TutorialsPageV2({ language }: { language: Language }) {
  ...
  const c = language === "fr" ? {
    ...
    result: "Résultat attendu", steps: "Étapes du tutoriel", available: "Tutoriel vidéo", preview: "Aperçu du tutoriel", launch: "Lancer le tutoriel", close: "Fermer le tutoriel", videoNote: "Vidéo test intégrée au site",
    ...
    result: "Expected result", steps: "Tutorial steps", available: "Video tutorial", preview: "Tutorial preview", launch: "Start tutorial", close: "Close tutorial", videoNote: "Test video embedded in the website",
